...
*/
// Optional
const CFGCOD = require('../modules/config/codeMst').CodeMst
...
const typeModule = 'codemst'
const typeFunctions = '/campaign-code'
const enpoint = '/campaign-code'
const logFile = 'logfpath'
const _COMPONENTID = 'CF-COD-00592299'
...
router.get(`${enpoint}/:dtlid/:cid/:extra`, async (req, res, next) => {
  /* Start pattern */
  let resp = {
    status: SVC.DEFAULT.code,
    msg: SVC.DEFAULT.msg
